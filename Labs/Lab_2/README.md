...
- `ex2-4/ex2/`: `ex2.xsl` transforms the movie list into a styled XHTML schedule.
- `ex2-4/ex3/`: `ex3.xsl` renders the same data but sorts the movies by title before outputting the table.
- `ex2-4/ex4/`: `ex4.xsl` focuses on **Titanic** and prints its hall and schedule information in a bordered grid, mapping each showtime to its weekday.
...
1. Run `xsltproc -o ex2-4/ex2/movies.html ex2-4/ex2/ex2.xsl ex1/movies.xml` to produce the main schedule page; open `ex2-4/ex2/movies.html` in a browser to verify the layout.
2. Run `xsltproc -o ex2-4/ex3/movies-sorted.html ex2-4/ex3/ex3.xsl ex1/movies.xml` to view the alphabetically sorted listing.
3. Run `xsltproc -o ex2-4/ex4/titanic-schedule.html ex2-4/ex4/ex4.xsl ex1/movies.xml` to generate the Titanic timetable.
